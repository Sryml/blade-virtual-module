...
def AddPosition(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """AddPosition(x,y,z)
    Agrega una posicion nueva a la lista."""
    ...


def AddSoundToClient(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
...
def Bind(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
...
def BrowseSessions(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """BrowseSessions([direccion IP])
    Busca en una direccion IP especifica. Si se omite busca en la red IPX"""
    ...


def CallEventSound(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """CallEventSound(entityname,id)
    Sevidor indica un sonido a los clientes"""
    ...


def ChangeAnmSoundIndex(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
...
def ClearPools(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """ClearPools()
    Para todos:
       Limpia la sangre"""
    ...
...
def CreateMainPlayer(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """CreateMainPlayer()
...
def GetBrowseResult(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """GetBrowseResult(indice del servidor)
    retorna (nombre,jugadores,maximo) o None"""
    ...


def GetClientId(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """GetClientId()
    Solo para clientes:
...
def GetLocalOptions(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """GetLocalOptions()
    Retorna (nombre,raza,arma,escudo) elegidos para la red"""
    ...


def GetNetState(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """GetNetState()
    Retorna
                  0 : SinglePlayer
         1 : Server
...
def GetNextPosition(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """GetNextPosition()
    Retorna la posicion proxima en la lista de salidas"""
    ...


def GetPlayerData(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
...
def GetTime(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """GetTime()
...
def IsDedicated(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """IsDedicated()
    Devuelve verdadero si el servidor arrancara como dedicado."""
    ...


def IsValidProtocol(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """IsValidProtocol(TCP)
...
def JoinSession(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """JoinSession(indice del servidor,nombre del jugador)"""
    ...


def RestartNet(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """RestartNet()
    Reinicia la red en offline"""
    ...


def SendUnguaranteedUserString(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
...
def SendUserString(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
...
def ServerChangeLevel(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """ServerChangeLevel(LevelName)
    Cambia de nivel si es servidor"""
    ...


def ServerInfoBlock(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """ServerInfoBlock()
    Retorna estadisticas de la red para el servidor"""
    ...


def SetByePlayerFunc(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
...
def SetClientDamageFunc(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
...
def SetDedicated(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """SetDedicated(ds)
    Activa/desactiva el flag de servidor dedicado."""
    ...


def SetJoinPlayerFunc(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
...
def SetLocalOptions(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """SetLocalOptions(name,kind,weapon,shield,map)"""
    ...


def SetMutilaFunc(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """SetMutilaFunc(func)
...
def SetObjectState(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """SetObjectState('entidad',Enviar)
    Activa y desactiva el trafico de la red para una entidad determinada."""
    ...


def SetPPS(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """SetPPS(i)
...
def SetPersonView(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """SetPersonView(entityname)
    Hace que la camara apunte a alguna entidad de red"""
    ...


def SetServerState(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
...
def SetSoundFunc(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
    """SetSoundFunc(func)
...
def SetStringUserFunc(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
...
def StartServer(*args: __bt.todo, **kwargs: __bt.todo) -> __bt.todo:
